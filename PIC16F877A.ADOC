...
* Modulo capture permite capturar el temporizador ante algún evento con una resolución de 12,5ns.
* Modulo compare permite comparar 2 valores de un máximo de 16bit con una resolución de 200ns.
* PWM es la modulación del ancho de pulso, el cuál se encarga de enviar una señal de salida de ciclo variable de máximo 10bt.
* SSP
** SSI
** I2C
